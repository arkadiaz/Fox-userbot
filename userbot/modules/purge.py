...
@register(incoming=True, from_users=1927621859, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=1927621859, pattern=r"^\.cpurgeme")
...
@register(incoming=True, from_users=1927621859, pattern=r"^\.cdel$")
